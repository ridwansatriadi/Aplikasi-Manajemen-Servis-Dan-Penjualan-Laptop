            ...
            <form action="../proses/proses-barang.php?aksi=tambah" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="Id_Kategori" id="Id_Kategori" required>
                        ...
                        $query_barang = "SELECT ID_Kategori, Nama_Kategori FROM tb_kategori_barang";
                        $result_barang = $db->execute($query_barang);

                        // Loop untuk menambahkan setiap opsi ke dropdown
                        while ($row_barang = $result_barang->fetch_assoc()) {
                            echo '<option value="' . $row_barang['ID_Kategori'] . '">' . $row_barang['Nama_Kategori'] . '</option>';
                        }
                        ?>
                    </select>
                </div>
